...
//     test("Student Presence", () async {
//       var studentPresences = await lectureRepository.getLecture(
//           subject.academicPeriodId, subject.subjectId, subject.subjectClass);

//       expect(studentPresences, isNotEmpty);
//       expect(studentPresences, isA<List<List<Lecture>>>());
//     });
//   });
// }
