...
class LecturerSubjectAssignmentsBody extends StatefulWidget {
  final Assignment assignment;

  const LecturerSubjectAssignmentsBody({
    super.key,
    required this.assignment,
  });

  @override
  State<LecturerSubjectAssignmentsBody> createState() =>
      _LecturerSubjectAssignmentsBodyState();
}

class _LecturerSubjectAssignmentsBodyState
    extends State<LecturerSubjectAssignmentsBody> {
