...
class LecturerMaterialsBody extends StatefulWidget {
  final Subject subject;
  final UserRepository userRepository;

  const LecturerMaterialsBody(
      {super.key, required this.subject, required this.userRepository});

  @override
  State<LecturerMaterialsBody> createState() => _LecturerMaterialsBodyState();
}

class _LecturerMaterialsBodyState extends State<LecturerMaterialsBody> {
  ...
  _checkLoad() async {
    bool loaded =
        await widget.userRepository.getWidgetState('lecturer_material');
    if (!loaded) {
      setState(() {
